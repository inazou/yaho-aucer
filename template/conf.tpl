...
<li><a href="javascript:void(0)" id="category" onclick="show('adSearch');"　>詳細検索設定</a></li>
        ...
        <div id="layer_adSearch" style="display: none;position:relative" class="close">
                        ...
                        <p>
                            <input type="number" name="aucminprice" value="<?php if(isset($data['aucminprice'])) echo htmlspecialchars($data['aucminprice'], ENT_QUOTES, 'UTF-8'); ?>" id="priceBox" style="width: 90px">円 ～ 
                            <input type="number" name="aucmaxprice" value="<?php if(isset($data['aucmaxprice'])) echo htmlspecialchars($data['aucmaxprice'], ENT_QUOTES, 'UTF-8'); ?>" id="priceBox" style="width: 90px">円
                        </p>
                        <p>即決価格: 
                        </p>
                        <p>
                            <input type="number" name="aucmin_bidorbuy_price" value="<?php if(isset($data['aucmin_bidorbuy_price'])) echo htmlspecialchars($data['aucmin_bidorbuy_price'], ENT_QUOTES, 'UTF-8'); ?>" id="priceBox" style="width: 90px">円 ～ 
                            <input type="number" name="aucmax_bidorbuy_price" value="<?php if(isset($data['aucmax_bidorbuy_price'])) echo htmlspecialchars($data['aucmax_bidorbuy_price'], ENT_QUOTES, 'UTF-8'); ?>" id="priceBox" style="width: 90px">円
                        </p>
                        <p>
                            <label> 
                                出品地域: 
